...
def do_experiments(start, end, step_num):
    ...
    for i, distance in enumerate(shift_distances, 1):
        ...
        # Implement: Calculate and plot decision boundary slope and intercept
    ...
    beta0_over_beta2 = [b0 / b2 for b0, b2 in zip(beta0_list, beta2_list)]
    plt.subplot(3, 3, 5)
    plt.plot(shift_distances, beta0_over_beta2, marker='o')
